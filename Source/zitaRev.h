...
public:
    ...
    virtual void buildUserInterface(UI* ui_interface) {
        ...
        ui_interface->addHorizontalBargraph("Compressor Gain Out", &fHbargraph0, -50.0f, 10.0f);
    ...
    virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
        ...
        for (int i = 0; (i < count); i = (i + 1)) {
            ...
            fHbargraph0 = FAUSTFLOAT((20.0f * std::log10(std::pow(10.0f, (0.0500000007f * fRec4[0])))));
